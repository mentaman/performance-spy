...
exports.spyFunctionTime = void 0;
const reset_counter_1 = require("../summary/reset-counter");
const spyFunctionTime = (myfunc, perfstat, key, { beforeResultsChecker = null, resultsChecker = null, checkArgs = false, keepFuncRefs = {} } = {}) => {
    return function () {
        if (keepFuncRefs.lastReset && (0, reset_counter_1.getCurrentReset)() > keepFuncRefs.lastReset) {
            keepFuncRefs.count = undefined;
            keepFuncRefs.lastArgs = undefined;
            keepFuncRefs.lastArgsKey = undefined;
        }
        keepFuncRefs.lastReset = (0, reset_counter_1.getCurrentReset)();
...
exports.spyFunctionTime = spyFunctionTime;
